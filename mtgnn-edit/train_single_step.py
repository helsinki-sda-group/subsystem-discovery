...
def train(data, X, Y, model, criterion, optim, batch_size):
    ...
    for X, Y in data.get_batches(X, Y, batch_size, True):
        ...
        if iter % args.step_size == 0:
            #perm = np.random.permutation(range(args.num_nodes)) # Note that the variables are randomly permutated
...
parser.add_argument('--save', type=str, default='weights/model.pt',
...
#parser.add_argument('--num_nodes',type=int,default=321,help='number of nodes/variables') # for electricity
parser.add_argument('--num_nodes',type=int,default=12,help='number of nodes/variables')  # for pendulum
parser.add_argument('--dropout',type=float,default=0.3,help='dropout rate')
#parser.add_argument('--subgraph_size',type=int,default=20,help='k') # default, for electricity
